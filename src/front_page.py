...
st.title("Football Player Stats 2022/2023")
st.header('Here are the different pages of my application:')

st.subheader("Query Squad")
st.text('''Query: Allows a user to enter a squad name and return information about it from 
        our database''')

st.subheader('Visualize')
st.text('Visualize: Allows a user to select the type of attribute and visualization')
